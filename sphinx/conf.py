...
## ignore imported modules in automodapi
...
exclude_patterns = []
#exclude_patterns = ['api/interaction.*.rst']
...
# Include custom CSS to expand content width
...
man_pages = [
    (master_doc, 'wp3', 'wp3 Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'wp3', 'wp3 Documentation',
     author, 'wp3', 'One line description of project.',
     'Miscellaneous'),
]
...
# Configure bibtex
bibtex_bibfiles = ['references.bib']  # List your BibTeX files here
